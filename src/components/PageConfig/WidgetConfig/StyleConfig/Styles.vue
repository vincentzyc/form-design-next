<template>
  <el-form-item :label="getLabel('percentWidth')" v-if="nStyle.hasOwnProperty('percentWidth')">
    ...
    <el-slider
      @input="(val: number) => updateStyle('width', `${val}%`)"
      class="pd-l10 pd-r10"
  ...
  <el-form-item :label="getLabel('pxWidth')" v-if="nStyle.hasOwnProperty('pxWidth')">
    <el-input-number
      ...
      :precision="0"
      :step="5"
      @change="(val: number) => updateStyle('width', `${val}px`)"
      size="small"
      step-strictly
  ...
  <el-form-item :label="getLabel('pxHeight')" v-if="nStyle.hasOwnProperty('pxHeight')">
    <el-input-number
      ...
      :precision="0"
      :step="5"
      @change="(v: number) => updateStyle('height', v + 'px')"
      size="small"
  ...
  <el-form-item :label="getLabel('marginleft')" v-if="nStyle.hasOwnProperty('marginleft')">
    <el-input-number
      :min="0"
      :step="1"
      @change="(val: number) => updateStyle('marginLeft', `${val}px`)"
      size="small"
      step-strictly
  ...
  <el-form-item :label="getLabel('margintop')" v-if="nStyle.hasOwnProperty('margintop')">
    <el-input-number
      :min="0"
      :step="1"
      @change="(val: number) => updateStyle('marginTop', `${val}px`)"
      size="small"
      step-strictly
  ...
  <el-form-item :label="getLabel('backgroundColor')" v-if="nStyle.hasOwnProperty('backgroundColor')">
    <el-color-picker
      ...
      @change="(v: string) => updateStyle('backgroundColor', v)"
      show-alpha
  ...
  <el-form-item :label="getLabel('color')" v-if="nStyle.hasOwnProperty('color')">
    <el-color-picker
      :predefine="predefineColors"
      @change="(v: string) => updateStyle('color', v)"
      show-alpha
  ...
  <el-form-item :label="getLabel('lineHeight')" v-if="nStyle.hasOwnProperty('lineHeight')">
    <el-input-number
      :max="200"
      :min="10"
      @change="(v: number) => updateStyle('lineHeight', v + 'px')"
      size="small"
  ...
  <el-form-item :label="getLabel('fontSize')" v-if="nStyle.hasOwnProperty('fontSize')">
    <el-input-number
      ...
      :min="10"
      :step="1"
      @change="(v: number) => updateStyle('fontSize', v + 'px')"
      size="small"
      step-strictly
  ...
  <el-form-item :label="getLabel('borderColor')" v-if="nStyle.hasOwnProperty('borderColor')">
    <el-color-picker
      :predefine="predefineColors"
      @change="(v: string) => updateStyle('borderColor', v)"
      show-alpha
  ...
  <el-form-item :label="getLabel('borderRadius')" v-if="nStyle.hasOwnProperty('borderRadius')">
    <el-input-number
      ...
      :min="0"
      :step="1"
      @change="(v: number) => updateStyle('borderRadius', v + 'px')"
      size="small"
      step-strictly
  ...
  <el-form-item :label="getLabel('borderWidth')" v-if="nStyle.hasOwnProperty('borderWidth')">
    <el-input-number
      ...
      :min="0"
      :step="1"
      @change="(v: number) => updateStyle('borderWidth', v + 'px')"
      size="small"
      step-strictly
